...
const new_games = `games?key=${process.env.API_KEY}&dates=${lastYear},${currentDate}&ordering=-released&page_size=10`;
...
export const searchedGameURL = game_name =>
  `${base_url}games?key=${process.env.API_KEY}&search=${game_name}&page_size=9`;
